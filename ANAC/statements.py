__all__ = [
    'DB_CREDENTIALS', 'DEFAULT_DOWNLOAD_PATH',
    'BATCH_SIZE', 'GET_TABLE_COLUMNS', 'INSERT_TABLES',
    'CREATE_TABLES', 'TABLES', 'GET_ALL_COLUMNS',
    'HASH_KEY', 'ADD_ID', 'CREATE_SINTESI',
    'INSERT_SINTESI', 'INSERT_LOADED', 'GET_LOADED',
    'RGX_DENOMINAZIONE', 'LAST_LOAD', 'CREATE_LOADED',
    'CREATEVIEW_SINTESI_CPV', 'URL_ANAC',
]
...
HASH_KEY = 'ALTER TABLE {} ADD COLUMN hash_{} BINARY(20) AS (UNHEX(SHA(CONCAT_WS(";",{})))) STORED INVISIBLE UNIQUE'

ADD_ID = 'ALTER TABLE {} ADD COLUMN id_{} BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY'

INSERT_LOADED = 'INSERT IGNORE INTO loaded (table_name, file_name) VALUES(%s, %s)'

GET_LOADED = 'SELECT file_name FROM loaded WHERE table_name = %s'
...
CREATE_LOADED = {
    ...
    CREATE TABLE IF NOT EXISTS loaded (
        ...
        data_inserimento DATETIME DEFAULT (CURRENT_DATE),
